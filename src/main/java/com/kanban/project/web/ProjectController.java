...
public class ProjectController {
	...
	public ResponseEntity<?> createNewProject(@Valid @RequestBody Project project, BindingResult bindingResult, Principal principal) {
		...
		ResponseEntity<?> errorMap = mapValidationErrorService.getMapValidationService(bindingResult);
		if(errorMap != null) return errorMap;
		
		Project result = projectService.saveOrUpdate(project, principal.getName());
